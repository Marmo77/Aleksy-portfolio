...
export function ProjectRow({ project, reverse }: { project: Project; reverse: boolean }) {
  const pillLabel = project.featured ? "FEATURED · MOST COMPLEX BUILD" : project.tag;
  ...
  return (
    ...
    >
      <div className="diagonal-stripes relative aspect-[4/3.15] w-full overflow-hidden rounded-[22px] border border-border bg-card-bg md:flex-[0_0_52%]">
        <div
      ...
      <div className="flex-1">
        ...
        <p className="mt-3 leading-relaxed text-text-muted">{project.summary}</p>
